...
def getData():
    ...
    mazeData = np.loadtxt(
        'aipython/SCMP/SCMP' + str(connectivity) + '/mazes/m' + connectivityPercentages[connectivity - 1] + '_' + str(
        maze) + '.mz')
    starts = np.loadtxt('aipython/SCMP/SCMP' + str(connectivity) + '/starting_locations.loc')
